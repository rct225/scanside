 ...
 * 	USB4716.h
 * Abstract:                                                          
 * 	header file for USB-4716 series driver
 *                                                                         
 * Version history		                                           
...
#ifndef _ADV_USB4716_H
#define _ADV_USB4716_H
...
typedef struct _private_data {
	...
	INT8U       bulk_endpointAddr; /* the address of the bulk endpoint */
	INT32U      device_type;
	INT16U      board_id;
	INT16U      user_cnt;
	...
	INT16U     terminated;
	INT32U     page_idx;
	INT32U     recieve_cnt; /* how many bytes has been received */
	INT32U     recieved; /* how many data item has been received */
