 ...
 *	advcnt.c
 * Abstract:
 *	This file contains routines for PCI1710 counter.
 *
 * Version history
 *      09/04/2006			Create by LI.ANG
 *
 *****************************************************************/
...
static INT32S adv_cnt_event_start(adv_device *device, adv_struct *structs, void *data)
{
	...
	advOutpw(privdata, 0x06, (advInpw(privdata, 0x06) | 0x0040) & 0x107f);
...
static INT32S adv_cnt_pulse_start(adv_device *device, cnt_struct *structs, INT32U *data)
{
	...
	advOutp(privdata, 0x06, advInp(privdata, 0x06) & 0x103f);
